...
export const reasonCopy: Record<ScoreReason, string> = {
  ...
  'paid-bounty': 'Paid bounty with a visible reward',
  'reward-signal': 'Reward or funding is mentioned',
  'no-reward-signal': 'No reward or funding visible',
  assigned: 'Already assigned — low chance to win',
  'open-to-claim': 'Open and unassigned',
  'high-competition': 'Crowded — many comments',
  'low-competition': 'Low competition so far',
