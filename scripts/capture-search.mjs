...
await page.getByRole('button', { name: /^good first issue$/i }).click()
...
await page.screenshot({ path: 'qa/tour/radar-populated.png', fullPage: true })
console.log(`radar rows: ${count}`)
await browser.close()
